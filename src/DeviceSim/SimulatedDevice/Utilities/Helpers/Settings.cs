...
//namespace SimulatedDevice.Utils.Helpers
//{
//  /// <summary>
...
namespace SimulatedDevice.Utils
{
    ...
    public class Settings : INotifyPropertyChanged
    {
        ...
        public LoginAccount LoginAccount
        {
            ...
            set { if (AppSettings.AddOrUpdateValue<int>(LoginAccountKey, (int) value)) OnPropertyChanged();        }
        }
        ...
        public bool MetricDistance
        {
            ...
            //set { if (AppSettings.AddOrUpdateValue<string>(MetricDistanceKey, value)) OnPropertyChanged();            }
        }

        public bool MetricUnits
        {
            get { return AppSettings.GetValueOrDefault(MetricUnitsKey, MetricUnitsDefault); }
            //set {if (AppSettings.AddOrUpdateValue<string>(MetricUnitsKey, value)) OnPropertyChanged();   }
        }
        ...
        public bool FirstRun
        {
            ...
            //set{if (AppSettings.AddOrUpdateValue<string>(FirstRunKey, value))  OnPropertyChanged(); }
        }
        ...
        public bool HasSyncedData
        {
            ...
            //set { AppSettings.AddOrUpdateValue<string>(HasSyncedDataKey, value); }
        }
        ...
        public DateTime LastSync
        {
            ...
            //set
            //{
            //    if (AppSettings.AddOrUpdateValue<string>(LastSyncKey, value))
            //        OnPropertyChanged();
            //}
        }
        ...
        public string UserUID
        {
            ...
            set { AppSettings.AddOrUpdateValue<string>(UserUIDKey, value); }
        }
        ...
        public string AzureMobileUserId
        {
            ...
            set { AppSettings.AddOrUpdateValue<string>(AzureMobileUserIdKey, value); }
        }
        ...
        public string UserProfileUrl
        {
            ...
            set { AppSettings.AddOrUpdateValue<string>(ProfileUrlKey, value); }
        }

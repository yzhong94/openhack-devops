    ...
    public class OBDDataProcessor
    {
        ...
        */
        private async Task SendBufferedDataToIOTHub()
        {
            ...
            //while (CrossConnectivity.Current.IsConnected && iotHubDataBlobs.Any()) //Old Cross Platform Code
            while (iotHubDataBlobs.Any())
            {
                try
                {
